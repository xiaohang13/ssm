...
<div id="app">
                        ...
                        <li v-for="(item,index) in productList">
                            <div class="cart-tab-1">
                                <div class="cart-item-check">
                                    <a href="javascipt:;" class="item-check-btn" v-bind:class="{check:item.checked}" v-on:click="selectProduct(item)">
                                ...
                                <div class="cart-item-pic">
                                    <img alt="item.productName" v-bind:src="item.productImage">
                                </div>
                                <div class="cart-item-title">
                                    <div class="item-name" v-text="item.productName"></div>
                                </div>
                                <div class="item-include">
                                    <dl v-for="bundled in item.parts">
                                        <dt>赠送:</dt>
                                        <dd>{{bundled.partsName}}</dd>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="cart-tab-3">
                                <div class="item-quantity">
                                    <div class="select-self select-self-open">
                                        <div class="quentity">
                                            <a href="javascript:;" v-on:click="changeNum(item,-1)">-</a>
                            ...
                            <div class="cart-tab-4">
                                <div class="item-price-total">{{item.productQuentity*item.productPrice | formatMoney}}</div>
                            </div>
            ...
            <div class="cart-foot-wrap">
                <div class="cart-foot-l">
                    <div class="item-all-check">
                        <a href="javascipt:;">
                <span class="item-check-btn" :class="{check:AllCheck}" @click="selectAllProduct(true)">
                    ...
                    <div class="item-all-del">
                        <a href="javascipt:;" class="item-del-btn" :class="{check:AllCheck}" @click="selectAllProduct(false)">
                            取消全选
                        </a>
                    </div>
                </div>
    ...
    <div class="md-modal modal-msg md-modal-transition" id="showModal" v-bind:class="{'md-show':showFlag}">
        <div class="md-modal-inner">
            <div class="md-top">
                <button class="md-close" v-on:click="showFlag=false">关闭</button>
            </div>
    ...
    <div class="md-overlay" v-if="showFlag"></div>
